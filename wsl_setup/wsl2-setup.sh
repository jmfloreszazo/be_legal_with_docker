...
#===============================================================================
# Generate .wslconfig for Windows
#===============================================================================

print_header "Generating .wslconfig Template"

WSLCONFIG_PATH="/mnt/c/Users/$USER/.wslconfig"
WSLCONFIG_TEMPLATE="$HOME/wslconfig-template.txt"

# Get total RAM in GB (rough estimate for recommendation)
TOTAL_RAM_KB=$(grep MemTotal /proc/meminfo | awk '{print $2}')
TOTAL_RAM_GB=$((TOTAL_RAM_KB / 1024 / 1024))
RECOMMENDED_RAM=$((TOTAL_RAM_GB / 2))

cat > "$WSLCONFIG_TEMPLATE" << EOF
# WSL2 Configuration File
# Copy this file to: C:\\Users\\YOUR_USERNAME\\.wslconfig
...
# Optional: Disable page reporting for better memory management
# pageReporting=false

# Optional: Enable nested virtualization (for Docker-in-Docker, etc.)
# nestedVirtualization=true
EOF

print_success "Template created: $WSLCONFIG_TEMPLATE"
print_info "Copy to Windows: C:\\Users\\YOUR_USERNAME\\.wslconfig"
...
echo "   cp $WSLCONFIG_TEMPLATE /mnt/c/Users/YOUR_USERNAME/.wslconfig"
echo ""
echo "2. Restart WSL from PowerShell:"
echo "   wsl --shutdown"
echo ""
echo "3. Start a new terminal session to apply all changes"
echo ""
echo "4. Keep your code in: ~/projects/"
